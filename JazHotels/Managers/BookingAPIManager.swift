...
func getReservation(userName:String, pinNumber:String,completion:  @escaping (_ :JBReservations?, _ :NSError?) -> Void)
{
    ...
    lobj_Request.httpBody=String(format: "%@%@", soapHeader,"<OTA_ReadRQ xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" EchoToken=\"JAZ-iOS_\(Helper.randomString(length: 10))\" PrimaryLangID=\"en-US\" ReturnListIndicator=\"True\" PrimaryLangId=\"en-US\" MaxResponses=\"0\" xmlns=\"http://www.opentravel.org/OTA/2003/05\"><ReadRequests><HotelReadRequest ChainCode=\"16401\"><UserID PinNumber=\"\(pinNumber)\" ID=\"\(userName)\"><CompanyName /></UserID></HotelReadRequest></ReadRequests><POS><Source><RequestorID ID=\"10\" ID_Context=\"Synxis\"><CompanyName Code=\"WSBE\" /></RequestorID></Source></POS></OTA_ReadRQ></v:Body></v:Envelope>").data(using: .ascii)
    
    print(String(format: "%@%@", soapHeader,"<OTA_ReadRQ xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" EchoToken=\"JAZ-iOS_\(Helper.randomString(length: 10))\" PrimaryLangID=\"en-US\" ReturnListIndicator=\"True\" PrimaryLangId=\"en-US\" MaxResponses=\"0\" xmlns=\"http://www.opentravel.org/OTA/2003/05\"><ReadRequests><HotelReadRequest ChainCode=\"16401\"><UserID PinNumber=\"\(pinNumber)\" ID=\"\(userName)\"><CompanyName /></UserID></HotelReadRequest></ReadRequests><POS><Source><RequestorID ID=\"10\" ID_Context=\"Synxis\"><CompanyName Code=\"WSBE\" /></RequestorID></Source></POS></OTA_ReadRQ></v:Body></v:Envelope>"))
    ...
    func cancelReservation(confirmationId:String,hotelCode:String,chainCode:String,completion:  @escaping (_ :CRCancelBookingModel?, _ :NSError?) -> Void) {
        ...
        lobj_Request.httpBody = String(format: "%@%@", soapHeader,"<OTA_CancelRQ xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" EchoToken=\"JAZ-iOS_\(Helper.randomString(length: 10))\" PrimaryLangID=\"en-US\" xmlns=\"http://www.opentravel.org/OTA/2003/05\"><TPA_Extensions><WrittenConfInst><SupplementalData Name=\"CancelConf\" Language=\"en-us\"><Text /></SupplementalData></WrittenConfInst></TPA_Extensions><UniqueID Type=\"14\" ID=\"\(confirmationId)\" ID_Context=\"CrsConfirmNumber\" /><Verification><TPA_Extensions><BasicPropertyInfo ChainCode=\"\(chainCode)\" HotelCode=\"\(hotelCode)\" /></TPA_Extensions></Verification><POS><Source><RequestorId ID=\"10\" ID_Context=\"Synxis\"><CompanyName Code=\"WSBE\" /></RequestorId><RequestorID ID=\"10\" ID_Context=\"Synxis\"><CompanyName Code=\"WSBE\" /></RequestorID></Source></POS></OTA_CancelRQ></v:Body></v:Envelope>").data(using: .ascii)
      print(String(format: "%@%@", soapHeader,"<OTA_CancelRQ xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" EchoToken=\"JAZ-iOS_\(Helper.randomString(length: 10))\" PrimaryLangID=\"en-US\" xmlns=\"http://www.opentravel.org/OTA/2003/05\"><TPA_Extensions><WrittenConfInst><SupplementalData Name=\"CancelConf\" Language=\"en-us\"><Text /></SupplementalData></WrittenConfInst></TPA_Extensions><UniqueID Type=\"14\" ID=\"\(confirmationId)\" ID_Context=\"CrsConfirmNumber\" /><Verification><TPA_Extensions><BasicPropertyInfo ChainCode=\"\(chainCode)\" HotelCode=\"\(hotelCode)\" /></TPA_Extensions></Verification><POS><Source><RequestorId ID=\"10\" ID_Context=\"Synxis\"><CompanyName Code=\"WSBE\" /></RequestorId><RequestorID ID=\"10\" ID_Context=\"Synxis\"><CompanyName Code=\"WSBE\" /></RequestorID></Source></POS></v:Body></v:Envelope>"))
